...
export class LuaPrinter {
    ...
    private printFile(file: lua.File): SourceNode {
        ...
        if (!this.options.noHeader) {
            header += "--The script generated by TypeScript.lua project\n";
        }
        header += "local _require = require\n"
        header += "local require=function(req) return req == 'mta' and _G or _require(req) end\n";
